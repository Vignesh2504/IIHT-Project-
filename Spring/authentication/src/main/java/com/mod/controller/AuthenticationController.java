...
public class AuthenticationController {
    ...
    public UserDetailsEntity getUsersUserName(@PathVariable String userEmail){
        return service.getUsersUserName(userEmail);
    }

    @RequestMapping("/mentor/details/{mentorEmail}")
    public MentorDetailsEntity getMentorsUserName(@PathVariable String mentorEmail){
        return service.getMentorsUserName(mentorEmail);
    }
